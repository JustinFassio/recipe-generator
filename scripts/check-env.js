...
if (typeof window !== 'undefined') {
  ...
  if (import.meta.env.VITE_SUPABASE_URL && import.meta.env.VITE_SUPABASE_URL.includes('127.0.0.1')) {
...
console.log('5. Update VITE_SUPABASE_ANON_KEY to your production Supabase anon key');

-- Complete Production Storage Fix
-- Run this in Supabase SQL Editor

-- 1. Create storage buckets if they don't exist
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
VALUES 
    ('recipe-images', 'recipe-images', true, 52428800, ARRAY['image/jpeg', 'image/png', 'image/webp', 'image/gif']),
...
-- 3. Grant permissions using a different approach
-- First, revoke all existing permissions
REVOKE ALL ON storage.objects FROM anon, authenticated, service_role;

-- Then grant the permissions we need

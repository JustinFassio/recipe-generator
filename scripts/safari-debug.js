...
if (typeof window !== 'undefined') {
  ...
  if (supabaseUrl) {
    const hasLocalhost = supabaseUrl.includes('127.0.0.1') || supabaseUrl.includes('localhost');
...
console.log('1. Update Vercel environment variables to use production Supabase URL');

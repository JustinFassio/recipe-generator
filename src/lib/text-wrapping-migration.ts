...
export const textWrappingClasses = {
  ...
  container:
    'min-h-screen bg-base-100 [&_.label-text-alt]:max-w-full [&_.label-text-alt]:overflow-hidden [&_.label-text-alt]:whitespace-normal [&_.label-text-alt]:break-words [&_.label]:max-w-full',

 ...
 * Currently uses localStorage for client-side storage, but can be easily extended
 * to use a database or API in the future.
 */
 ...
 */
export const saveEvaluationReport = (
  userId: string,
 ...
 */
export const getUserEvaluationReports = (
  userId: string
): EvaluationReport[] => {
  try {
    const storageKey = `evaluation_reports_${userId}`;
 ...
 */
export const getEvaluationReportById = (
  userId: string,
  reportId: string
): EvaluationReport | null => {
  try {
    const reports = getUserEvaluationReports(userId);
    return (
      reports.find(
 ...
 */
export const deleteEvaluationReport = (
  userId: string,
  reportId: string
): boolean => {
  try {
 ...
 */
export const hasEvaluationReports = (userId: string): boolean => {
  try {
    const reports = getUserEvaluationReports(userId);
 ...
 */
export const getLatestEvaluationReport = (
  userId: string
): EvaluationReport | null => {
  try {
    const reports = getUserEvaluationReports(userId);

    ...
    switch (personaType) {
      case 'chef':
        return {
          ...
          guidance: "Start by telling me what kind of recipe you'd like to create, or use the preferences above to guide me."
        };
      case 'nutritionist':
        return {
      ...
      case 'assistantNutritionist':
        return {
          ...
          description: "🌟 PREMIUM: Master of Integrative Culinary Medicine with 30+ years merging ancient healing wisdom with cutting-edge nutritional science. Expert in TCM, Ayurveda, functional medicine, and microbiome optimization.",
          guidance: "Transform your kitchen into a healing pharmacy! Tell me about your health goals, dietary needs, or what you'd like to heal through food."
        };
      case 'jamieBrightwell':
        return {
          title: "Welcome! I'm Dr. Jamie Brightwell",
          description: "🌟 PREMIUM: Revolutionary Pediatric Culinary Wellness Expert with dual Stanford medicine + Le Cordon Bleu training. Transform 'picky eaters' into food explorers with 25+ years of evidence-based, play-based nutrition.",
          guidance: "Let's create healthy, kid-friendly meals that your little ones will actually love! Tell me about your child's age, preferences, or any dietary challenges you're facing."
        };
      default:
        return {

...
export default function EvaluationReportPage() {
  ...
  // Helper function to check if report has raw content (fallback format)
  const isFallbackReport = (report: EvaluationReport) => {
    return (
      (report.user_evaluation_report as Record<string, unknown>).report_type ===
        'fallback_text' ||
      (report.user_evaluation_report as Record<string, unknown>).report_type ===
        'multi_part_text' ||
      (report.user_evaluation_report as Record<string, unknown>).raw_content
    );
  };
          ...
          {selectedReport && (
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                ...
                {/* Show raw content for fallback reports */}
                {isFallbackReport(selectedReport) ? (
                  <div className="space-y-4">
                    <div className="alert alert-info">
                      ...
                      <div>
                        ...
                        <div className="text-xs">
                          This report was saved in raw format. The structured
                          view will be available after completing the full
                          health evaluation.
                        </div>
                      </div>
                    </div>
                    <div className="bg-muted p-4 rounded-lg">
                      <pre className="whitespace-pre-wrap text-sm font-mono">
                        {((
                          selectedReport.user_evaluation_report as Record<
                            string,
                            unknown
                          >
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          ...
                          <div className="text-center p-3 bg-muted rounded-lg">
                            <div className="text-2xl font-bold text-primary">
                              {selectedReport.user_evaluation_report
                                .report_metadata?.confidence_level || 85}
                              %
                            </div>
                            <div className="text-sm text-muted-foreground">
                              Confidence
                          ...
                          <div className="text-center p-3 bg-muted rounded-lg">
                            <div className="text-2xl font-bold text-primary">
                              {selectedReport.user_evaluation_report
                                .report_metadata?.data_completeness || 100}
                              %
                            </div>
                            <div className="text-sm text-muted-foreground">
                              Data Complete
                        ...
                        <div className="space-y-2">
                          {selectedReport.user_evaluation_report.next_steps?.immediate_72_hours?.map(
                            ...
                            <div className="p-3 bg-muted rounded text-sm text-muted-foreground">
                              Next steps will be available after completing the
                              health evaluation.
                            </div>
                          )}
                        </div>
                    ...
                    <div className="tab-content hidden" data-tab="safety">
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          {/* Critical Alerts */}
                          {selectedReport.user_evaluation_report
                            .safety_assessment.critical_alerts.length > 0 && (
                            <div>
                          ...
                          {selectedReport.user_evaluation_report
                            .safety_assessment.dietary_restrictions.length >
                            0 && (
                            <div>
                              <h4 className="font-medium mb-2">
                                Dietary Restrictions
                                  ...
                                  (restriction, index) => (
                                    ...
                                    >
                                      ...
                                      <p className="text-sm mb-2">
                                        Tolerance:{' '}
                                        {restriction.tolerance_threshold}
                                      </p>
                                      <div className="text-xs">
                                        <span className="font-medium">
                                          Safe alternatives:

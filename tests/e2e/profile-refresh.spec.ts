...
test.describe('Profile Refresh and Update', () => {
  test('should refresh profile data after updates', async ({
    authenticatedPage,
  }) => {
  ...
  test('should refresh profile data on page reload', async ({
    authenticatedPage,
  }) => {
    await authenticatedPage.goto('/profile');
  ...
  test('should maintain profile state across tab switches', async ({
    authenticatedPage,
  }) => {
    await authenticatedPage.goto('/profile');
  ...
  test('should refresh profile data when navigating back to profile', async ({
    authenticatedPage,
  }) => {
  ...
  test('should handle profile refresh errors gracefully', async ({
    authenticatedPage,
  }) => {
    await authenticatedPage.goto('/profile');
    ...
    await expect(
      authenticatedPage.getByText(/error|failed|offline/i)
  ...
  test('should refresh multiple profile sections independently', async ({
    authenticatedPage,
  }) => {
    await authenticatedPage.goto('/profile');
  ...
  test('should show loading states during profile refresh', async ({
    authenticatedPage,
  }) => {
    await authenticatedPage.goto('/profile');
    ...
    await expect(
      authenticatedPage.getByText(/loading|saving|updating/i)
    ).toBeVisible();

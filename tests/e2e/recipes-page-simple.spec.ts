...
test.describe('Recipes Page Simple Review', () => {
  test('should login and see recipes page structure', async ({ authenticatedPage }) => {
  ...
  test('should find all main buttons on recipes page', async ({ authenticatedPage }) => {
    await authenticatedPage.goto('/recipes');
    await authenticatedPage.waitForLoadState('networkidle');
  ...
  test('should check recipes loading state', async ({ authenticatedPage }) => {
    ...
    if (isLoading) {
      console.log('⏳ Recipes are still loading (likely due to database connectivity issues)');
  ...
  test('should test navigation to add recipe page', async ({ authenticatedPage }) => {
    await authenticatedPage.goto('/recipes');
    await authenticatedPage.waitForLoadState('networkidle');
  ...
  test('should test navigation to AI recipe creator', async ({ authenticatedPage }) => {
    await authenticatedPage.goto('/recipes');
    await authenticatedPage.waitForLoadState('networkidle');
